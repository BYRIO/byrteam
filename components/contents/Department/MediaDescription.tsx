import MediaWechatLg from '@/assets/images/departments/media/WeChat-lg.svg';
import MediaWechatSm from '@/assets/images/departments/media/WeChat-sm.svg';
...
import { ChalkSpan2 } from './departments';
...
export function MediaDescriptionSm(){
  return (
    <div className="flex flex-col relative items-center gap-2">
        <MediaWechatSm />
      <div className='z-10 flex flex-col items-center'>
        <ChalkSpan2 content='Hi，欢迎来到有趣灵魂聚集地——' />
        <ChalkSpan2 content='新媒体组！ 我们是——' />
      </div>
      
      <div className="absolute inset-2 z-0 overflow-hidden">
            <MediaStarLg className="absolute top-28 left-3" />
            <MediaStarSm className="absolute bottom-0 -left-20" />
      </div>
...
export function MediaDescriptionLg() {
  return (
    <div className="flex flex-col items-center gap-2">
      <MediaWechatLg />
      <article className="w-full px-10">
        <ChalkSpan2 content='Hi，欢迎来到有趣灵魂聚集地——新媒体组！ 我们是——' />
        <section className="relative flex justify-between leading-[180%]">
          <div className="absolute z-0 overflow-hidden">
            <MediaStarLg className="absolute left-12" />
            <MediaStarSm className="absolute -bottom-36 right-0" />
          </div>
